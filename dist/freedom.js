...
__webpack_require__.d(__webpack_exports__, {
  ...
  "EventService": () => (/* reexport */ EventService),
...
;// CONCATENATED MODULE: ./src/services/event.js


const DEFAULT_VALUE = utils/* Str.rand */.W3.rand(utils/* Str.rand */.W3.rand((0,utils/* date */.hT)('ms')));
...
class EventService {
    ...
    sub(id){
        if((0,utils/* objectHasKey */.aX)(this.__subServices, id)) return this.__subServices[id];
    ...
    addSub(id, sub){
        if(!sub){
            if((0,utils/* objectHasKey */.aX)(this.__subServices, id)){
    ...
    removeSub(id){
        ...
        }else if(!(0,utils/* isEmpty */.xb)(this.__subServices)){
    ...
    dispatchEvent(event, data, log) {
        ...
        var e = {};
        if ((0,utils/* isString */.HD)(event)) {
            e.type = event;
            if (data) {
                e.data = data;
            }
            // console.log(event, data);
        } else if ((0,utils/* isObject */.Kn)(event)) {
            e = event;
            if (!e.type) return false;
            if (!e.data && data) {
                e.data = data;
            }
            if ((0,utils/* isBoolean */.jn)(data) && typeof log == "undefined") {
                log = data;
            }
        }
        else {
    ...
    on(type, listener, dispatch) {
        if ((0,utils/* isObject */.Kn)(type)) {
            var listeners = {};
            const events = type;
            var d = (0,utils/* isBoolean */.jn)(listener) ? listener : ((0,utils/* isBoolean */.jn)(dispatch) ? dispatch : false);
            for (const key in events) {
                if (Object.hasOwnProperty.call(events, key)) {
                    const fn = type[key];
                    if ((0,utils/* isFunction */.mf)(fn) || (0,utils/* isString */.HD)(fn)) {
     ...
     */
    emit(event, data, log) {
        return this.dispatchEvent.apply(this, (0,utils/* getArguments */.Tu)(arguments));
    }
    /**
     * Tạo, gọi ra một sự kiện
     * @param {string|object} event Tên hoặc sự kiện
